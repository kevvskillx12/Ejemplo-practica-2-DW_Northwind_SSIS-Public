/*
    ...
    Descripción:
    Crea la base de datos DW_Northwind y sus tablas:
    Products, Customers, Employees, Suppliers, Time y Orders.
*/
...
-- Eliminar tablas si ya existen, respetando dependencias
...
CREATE TABLE dbo.Orders (
    ...
    CONSTRAINT FK_Orders_Time
        FOREIGN KEY (TimeID) REFERENCES dbo.[Time](ID)
);
GO